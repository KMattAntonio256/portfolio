...
My key accomplishments were mainly as a coder and assistant, with me discovering how to code in Mermaid, like in the chart below:
...
[![My RPS Game](images/about/rps.png)](https://ahmad-se-tech.github.io/tablegroup/rock-paper-scissor/)

A different key accomplishment I had as a coder and assistant was learning about booleans one of the fundamentals of javascript, as seen [here](https://pages.opencodingsociety.com/js/booleans)

Also, I learned how to ask AI to make more mind numbing tasks actually fun to test and fix mistakes in my code.