...
Next, use an LLM (Claude works particularly well for coding) to help bring those ideas to life and truly experience them.
...
There were standout projects across multiple levels — a CSP game teaching concepts about crypto mining, and a CSP/CSA project using a Gemini backend that could process both text and images, including one that analyzed news sources and identified their political leanings.
...
*Note: The following photos were taken by a friend, as my phone was unavailable at the time.*
